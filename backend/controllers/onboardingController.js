...
const saveApplication = async (req, res, next) => {
  try {
    ...
    const applicationData = {
      ...
      middleName,
      preferredName,
      profilePicture: buildFileInfo(profilePictureFile),
      address,
      cellPhone,
      workPhone,
      ...
      workAuthorization: {
        ...workAuthorization,
        optReceipt: optReceiptDocument?._id || workAuthorization.optReceipt || null,
      },
      driverLicense: buildFileInfo(driverLicenseFile),
      reference,
      emergencyContacts,
      status: "pending",
      feedback: "",
